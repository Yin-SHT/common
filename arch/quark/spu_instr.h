...
public:
  ...
  QUARK_GEN_GETTER_SETTER(RLength, 19, 19);
...
public:
  ...
  QUARK_GEN_GETTER_SETTER(Length, 19, 19);
...
public:
  explicit CpyInstr() : SpuInstr(OpCodeType::CPY) {
    QUARK_PUSH_GETTER_SETTER(VolIdx);
    QUARK_PUSH_GETTER_SETTER(SurIdx);
    QUARK_PUSH_GETTER_SETTER(LineIdx);
    QUARK_PUSH_GETTER_SETTER(RLength);
    QUARK_PUSH_GETTER_SETTER(DynamicSrc);
    QUARK_PUSH_GETTER_SETTER(DynamicDst);
    QUARK_PUSH_GETTER_SETTER(Bank);
    QUARK_PUSH_GETTER_SETTER(Dtype);
  ...
  QUARK_GEN_GETTER_SETTER(DynamicSrc, 15, 15);
  QUARK_GEN_GETTER_SETTER(DynamicDst, 14, 14);
