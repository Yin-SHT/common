...
const AddrRange kSystemNeDdrRt1MemMap = {0x6800000000, 0x681effffff};
const AddrRange kSystemNeDdrFw1MemMap = {0x6820000000, 0x6827ffffff};
const AddrRange kSystemNeDdrOtherMemMap = {0x6828000000, 0x6dffffffff};
const AddrRange kSystemSwDdrRt2MemMap = {0x7000000000, 0x701effffff};
const AddrRange kSystemSwDdrFw2MemMap = {0x7020000000, 0x7027ffffff};
const AddrRange kSystemSwDdrOtherMemMap = {0x7028000000, 0x75ffffffff};
const AddrRange kSystemSeDdrRt3MemMap = {0x7800000000, 0x781effffff};
const AddrRange kSystemSeDdrFw3MemMap = {0x7820000000, 0x7827ffffff};
...
enum SpuSetIndexMap {
  ...
  SpuSrcMoAddr6 = 38,
  SpuSrcMoAddr7 = 39,
  SpuSrcScale0Addr0 = 40,
  SpuSrcScale0Addr1 = 41,
  SpuSrcScale0Addr2 = 42,
  SpuSrcScale0Addr3 = 43,
  SpuSrcScale0Addr4 = 44,
  SpuSrcScale0Addr5 = 45,
  SpuSrcScale0Addr6 = 46,
  SpuSrcScale0Addr7 = 47,
  SpuSrcScale1Addr0 = 48,
  SpuSrcScale1Addr1 = 49,
  SpuSrcScale1Addr2 = 50,
  SpuSrcScale1Addr3 = 51,
  SpuSrcScale1Addr4 = 52,
  SpuSrcScale1Addr5 = 53,
  SpuSrcScale1Addr6 = 54,
  SpuSrcScale1Addr7 = 55,
  SpuSrcScale2Addr0 = 56,
  SpuSrcScale2Addr1 = 57,
  SpuSrcScale2Addr2 = 58,
  SpuSrcScale2Addr3 = 59,
  SpuSrcScale2Addr4 = 60,
  SpuSrcScale2Addr5 = 61,
  SpuSrcScale2Addr6 = 62,
  SpuSrcScale2Addr7 = 63,
  SpuSrcAccAddr0 = 64,
  SpuSrcAccAddr1 = 65,
  SpuSrcAccAddr2 = 66,
  SpuSrcAccAddr3 = 67,
  ...
  SpuSrcAcpStride2 = 98,
  SpuSrcAcpStride3 = 99,
  SpuSrcAcpStride4 = 100,
  SpuSrcAcpStride5 = 101,
  SpuSrcAcpStride6 = 102,
  SpuSrcAcpStride7 = 103,
  SpuSrcMiStride0 = 104,
  SpuSrcMiStride1 = 105,
  SpuSrcMiStride2 = 106,
  SpuSrcMiStride3 = 107,
  ...
  SpuSrcMoStride6 = 118,
  SpuSrcMoStride7 = 119,
  SpuSrcScale0Stride0 = 120,
  SpuSrcScale0Stride1 = 121,
  SpuSrcScale0Stride2 = 122,
  SpuSrcScale0Stride3 = 123,
  SpuSrcScale0Stride4 = 124,
  SpuSrcScale0Stride5 = 125,
  SpuSrcScale0Stride6 = 126,
  SpuSrcScale0Stride7 = 127,
  SpuSrcScale1Stride0 = 128,
  SpuSrcScale1Stride1 = 129,
  SpuSrcScale1Stride2 = 130,
  SpuSrcScale1Stride3 = 131,
  SpuSrcScale1Stride4 = 132,
  SpuSrcScale1Stride5 = 133,
  SpuSrcScale1Stride6 = 134,
  SpuSrcScale1Stride7 = 135,
  SpuSrcScale2Stride0 = 136,
  SpuSrcScale2Stride1 = 137,
  SpuSrcScale2Stride2 = 138,
  SpuSrcScale2Stride3 = 139,
  SpuSrcScale2Stride4 = 140,
  SpuSrcScale2Stride5 = 141,
  SpuSrcScale2Stride6 = 142,
  SpuSrcScale2Stride7 = 143,
  SpuSrcAccStride0 = 144,
  SpuSrcAccStride1 = 145,
  SpuSrcAccStride2 = 146,
  SpuSrcAccStride3 = 147,
  SpuSrcAccStride4 = 148,
  SpuSrcAccStride5 = 149,
  SpuSrcAccStride6 = 150,
  SpuSrcAccStride7 = 151,
  SpuDstTsrStride0 = 152,
  SpuDstTsrStride1 = 153,
  SpuDstTsrStride2 = 154,
  SpuDstTsrStride3 = 155,
  SpuDstTsrStride4 = 156,
  SpuDstTsrStride5 = 157,
  SpuDstTsrStride6 = 158,
  SpuDstTsrStride7 = 159,
  SpuSrcTsrLength0 = 160,
  SpuSrcTsrLength1 = 161,
  SpuSrcWgtLength0 = 162,
  SpuSrcWgtLength1 = 163,
  SpuSrcAcpLength0 = 164,
  SpuSrcAcpLength1 = 165,
  SpuSrcMiLength0 = 166,
  SpuSrcMiLength1 = 167,
  SpuSrcMoLength0 = 168,
  SpuSrcMoLength1 = 169,
  SpuSrcScale0Length = 170,
  SpuSrcScale1Length0 = 171,
  SpuSrcScale1Length1 = 172,
  SpuSrcScale2Length0 = 173,
  SpuSrcScale2Length1 = 174,
  SpuSrcBiasLength = 175,
  SpuSrcAccLength0 = 176,
  SpuSrcAccLength1 = 177,
  SpuDstTsrLength0 = 178,
  SpuDstTsrLength1 = 179,
  SpuDstTsrLength2 = 180,
  SpuDstTsrLength3 = 181,
  SpuSrcTsrBankStride = 182,
  SpuSrcWgtBankStride = 183,
  SpuSrcAcpBankStride = 184,
  SpuSrcMiBankStride = 185,
};
...
enum PeRegisterDef {
  ...
  PELS_I_LOOP_COUNT0 = 128,
  PELS_I_LOOP_COUNT1 = 132,
  PELS_I_LOOP_COUNT2 = 136,
  PELS_I_LOOP_COUNT3 = 140,
  PELS_I_LOOP_COUNT4 = 144,
  PELS_I_LOOP_COUNT5 = 148,
  PELS_I_LOOP_COUNT6 = 152,
  PELS_I_LOOP_COUNT7 = 156,
  PELS_E_LOOP_COUNT0 = 160,
  PELS_E_LOOP_COUNT1 = 164,
  PELS_E_LOOP_COUNT2 = 168,
  PELS_E_LOOP_COUNT3 = 172,
  PELS_E_LOOP_COUNT4 = 176,
  PELS_E_LOOP_COUNT5 = 180,
  PELS_E_LOOP_COUNT6 = 184,
  PELS_E_LOOP_COUNT7 = 188,
  PELS_O_LOOP_COUNT0 = 192,
  PELS_O_LOOP_COUNT1 = 196,
  PELS_O_LOOP_COUNT2 = 200,
  PELS_O_LOOP_COUNT3 = 204,
  PELS_O_LOOP_COUNT4 = 208,
  PELS_O_LOOP_COUNT5 = 212,
  PELS_O_LOOP_COUNT6 = 216,
  PELS_O_LOOP_COUNT7 = 220,
  CORE_PHY_LOGIC_ID_TABLE = 224,
  CORE0_PE_PHY_LOGIC_ID_TABLE_L = 240,
  CORE0_PE_PHY_LOGIC_ID_TABLE_H = 244,
  CORE1_PE_PHY_LOGIC_ID_TABLE_L = 248,
  CORE1_PE_PHY_LOGIC_ID_TABLE_H = 252,
  CORE2_PE_PHY_LOGIC_ID_TABLE_L = 256,
  CORE2_PE_PHY_LOGIC_ID_TABLE_H = 260,
  CORE3_PE_PHY_LOGIC_ID_TABLE_L = 264,
  CORE3_PE_PHY_LOGIC_ID_TABLE_H = 268,
  PE_PARITY_CHECK = 272,
  PE_MEM_CFG_L = 280,
  PE_MEM_CFG_H = 284,
};
...
enum SpuRegisterDef {
  ...
  SPU_SRC_MI_ADDR0 = 28,
  SPU_SRC_MO_ADDR0 = 32,
  SPU_SRC_SCALE0_ADDR0 = 36,
  SPU_SRC_SCALE1_ADDR0 = 40,
  SPU_SRC_SCALE2_ADDR0 = 44,
  SPU_SRC_ACC_ADDR0 = 48,
  SPU_DST_TSR_ADDR0 = 52,
  ...
  SPU_SRC_MO_STRIDE0 = 192,
  SPU_SRC_MO_STRIDE1 = 196,
  SPU_SRC_MO_STRIDE2 = 200,
  SPU_SRC_MO_STRIDE3 = 204,
  SPU_SRC_MO_STRIDE4 = 208,
  SPU_SRC_MO_STRIDE5 = 212,
  SPU_SRC_MO_STRIDE6 = 216,
  SPU_SRC_MO_STRIDE7 = 220,
  SPU_SRC_SCALE0_STRIDE0 = 224,
  SPU_SRC_SCALE0_STRIDE1 = 228,
  SPU_SRC_SCALE0_STRIDE2 = 232,
  SPU_SRC_SCALE0_STRIDE3 = 236,
  SPU_SRC_SCALE0_STRIDE4 = 240,
  SPU_SRC_SCALE0_STRIDE5 = 244,
  SPU_SRC_SCALE0_STRIDE6 = 248,
  SPU_SRC_SCALE0_STRIDE7 = 252,
  SPU_SRC_SCALE1_STRIDE0 = 256,
  SPU_SRC_SCALE1_STRIDE1 = 260,
  SPU_SRC_SCALE1_STRIDE2 = 264,
  SPU_SRC_SCALE1_STRIDE3 = 268,
  SPU_SRC_SCALE1_STRIDE4 = 272,
  SPU_SRC_SCALE1_STRIDE5 = 276,
  SPU_SRC_SCALE1_STRIDE6 = 280,
  SPU_SRC_SCALE1_STRIDE7 = 284,
  SPU_SRC_SCALE2_STRIDE0 = 288,
  SPU_SRC_SCALE2_STRIDE1 = 292,
  SPU_SRC_SCALE2_STRIDE2 = 296,
  SPU_SRC_SCALE2_STRIDE3 = 300,
  SPU_SRC_SCALE2_STRIDE4 = 304,
  SPU_SRC_SCALE2_STRIDE5 = 308,
  SPU_SRC_SCALE2_STRIDE6 = 312,
  SPU_SRC_SCALE2_STRIDE7 = 316,
  SPU_SRC_ACC_STRIDE0 = 320,
  SPU_SRC_ACC_STRIDE1 = 324,
  SPU_SRC_ACC_STRIDE2 = 328,
  SPU_SRC_ACC_STRIDE3 = 332,
  SPU_SRC_ACC_STRIDE4 = 336,
  SPU_SRC_ACC_STRIDE5 = 340,
  SPU_SRC_ACC_STRIDE6 = 344,
  SPU_SRC_ACC_STRIDE7 = 348,
  SPU_DST_TSR_STRIDE0 = 352,
  SPU_DST_TSR_STRIDE1 = 356,
  SPU_DST_TSR_STRIDE2 = 360,
  SPU_DST_TSR_STRIDE3 = 364,
  SPU_DST_TSR_STRIDE4 = 368,
  SPU_DST_TSR_STRIDE5 = 372,
  SPU_DST_TSR_STRIDE6 = 376,
  SPU_DST_TSR_STRIDE7 = 380,
  SPU_SRC_TSR_LENGTH0 = 384,
  SPU_SRC_TSR_LENGTH1 = 388,
  SPU_SRC_WGT_LENGTH0 = 392,
  SPU_SRC_WGT_LENGTH1 = 396,
  SPU_SRC_ACP_LENGTH0 = 400,
  SPU_SRC_ACP_LENGTH1 = 404,
  SPU_SRC_MI_LENGTH0 = 408,
  SPU_SRC_MI_LENGTH1 = 412,
  SPU_SRC_MO_LENGTH0 = 416,
  SPU_SRC_MO_LENGTH1 = 420,
  SPU_SRC_SCALE0_LENGTH = 424,
  SPU_SRC_SCALE1_LENGTH0 = 432,
  SPU_SRC_SCALE1_LENGTH1 = 436,
  SPU_SRC_SCALE2_LENGTH0 = 440,
  SPU_SRC_SCALE2_LENGTH1 = 444,
  SPU_SRC_BIAS_LENGTH = 448,
  SPU_SRC_ACC_LENGTH0 = 456,
  SPU_SRC_ACC_LENGTH1 = 460,
  SPU_DST_TSR_LENGTH0 = 464,
  SPU_DST_TSR_LENGTH1 = 468,
  SPU_DST_TSR_LENGTH2 = 472,
  SPU_DST_TSR_LENGTH3 = 476,
  SPU_SRC_TSR_BANK_STRIDE = 480,
  SPU_SRC_WGT_BANK_STRIDE = 484,
  SPU_SRC_ACP_BANK_STRIDE = 488,
  SPU_SRC_MI_BANK_STRIDE = 492,
  SPU_LOOP_COUNT0 = 496,
  SPU_LOOP_COUNT1 = 500,
  SPU_LOOP_COUNT2 = 504,
  SPU_LOOP_COUNT3 = 508,
...
enum VpuRegisterDef {
  ...
  VPU_GPR31 = 140,
  VPU_LD_STRIDE = 144,
  VPU_LD_PORT_MASK = 148,
  VPU_LD_PORT_BCAST = 152,
  VPU_LD_BANK_MASK = 156,
  VPU_LD_BANK_BCAST = 160,
  VPU_LD_CH_BCAST = 164,
  VPU_LD_BASE_ADDR0 = 168,
  VPU_LD_BASE_ADDR1 = 172,
  VPU_LD_DQT_FACTOR0 = 176,
  VPU_LD_DQT_FACTOR1 = 180,
  VPU_ST_STRIDE = 184,
  VPU_ST_PORT_MASK = 188,
  VPU_ST_BANK_MASK = 192,
  VPU_ST_BASE_ADDR = 196,
  VPU_ST_QNT_FACTOR = 200,
  VPU_FORMAT_SELECT = 204,
};
...
enum DmaRegisterDef {
  ...
  DMAC_PROXY_HANDSHAKE = 336,
  DMAC_PROXY_DONE = 340,
  DMAC_DATA_BCAST_MODE = 352,
};
...
enum CoreRegisterDef {
  ...
  IDU_TIME_OUT = 772,
  IDU_INVALID = 776,
  IDU_INVALID_DONE = 780,
  CORE_PARITY_CHECK = 784,
  CORE_MEM_CFG_L = 792,
  CORE_MEM_CFG_H = 796,
  WAIT_CORE_IDLE_CFG = 800,
  WAIT_CORE_BOUNDARY_CFG = 804,
  CORE_RST_TIME_CFG = 808,
  PE_SOFT_RH_RESET = 812,
  PE_FORCE_RH_RESET = 816,
  PE_RESET = 820,
  PE_RH_REL = 824,
  PE_RH_DONE = 828,
  IDU_INT_VALID = 832,
  IDU_INT_CLEAR = 836,
  IDU_INT_ST_CLEAR = 840,
  IDU_INT = 844,
  IDU_PAR_ERR_INS = 848,
  IDU_PAR_ERR_INT = 852,
  COLS_INT_VALID = 864,
  COLS_INT_CLEAR = 868,
  COLS_INT_ST_CLEAR = 872,
  COLS_INT = 876,
  COLS_LOOP_COUNT0 = 880,
  COLS_LOOP_COUNT1 = 884,
  COLS_LOOP_COUNT2 = 888,
  COLS_LOOP_COUNT3 = 892,
  COLS_LOOP_COUNT4 = 896,
  COLS_LOOP_COUNT5 = 900,
  COLS_LOOP_COUNT6 = 904,
  COLS_LOOP_COUNT7 = 908,
  DDMA_INT_VALID = 912,
  DDMA_INT_CLEAR = 916,
  DDMA_INT_ST_CLEAR = 920,
  DDMA_INT = 924,
  DDMA_PAR_ERR_INS = 928,
  DDMA_PAR_ERR_INT = 932,
  CODMA_INT_VALID = 944,
  CODMA_INT_CLEAR = 948,
  CODMA_INT_ST_CLEAR = 952,
  CODMA_INT = 956,
  PE_SOFT_RST = 960,
  PE_RST_RDY = 964,
  PE_RST = 968,
...
enum CodmaRegisterDef {
  ...
  CODMAC_C2C_DCID = 336,
  CODMAC_C2C_OPTION = 340,
  CODMAC_C2C_UMSG_L = 344,
  CODMAC_C2C_UMSG_H = 348,
  CODMAC_C2C_CFG_ST = 352,
};
