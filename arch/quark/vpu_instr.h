...
public:
  ...
  static const std::map<OpCodeType, OpCodeItem>& getOpCodeMap() {
    static const std::map<OpCodeType, OpCodeItem> opCodeMap = {
      ...
      {OpCodeType::I32_DLOAD,            {"i32_dload",            0xff0f0000, 0xd0020000}},
      {OpCodeType::I32_LOAD,             {"i32_load",             0xffcf0000, 0xd0000000}},
      ...
      {OpCodeType::I32_STORE,            {"i32_store",            0xffcf0000, 0xd8000000}},
