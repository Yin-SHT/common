...
DLL_PUBLIC float quark_vpu_dequant_i4_to_fp32(uint32_t x, uint32_t f);
DLL_PUBLIC float quark_vpu_dequant_fp4_to_fp32(uint32_t x, uint32_t f);
...
DLL_PUBLIC uint32_t quark_vpu_quant_fp32_to_i4(float x, uint32_t f);
DLL_PUBLIC uint32_t quark_vpu_quant_fp32_to_fp4(float x, uint32_t f);
